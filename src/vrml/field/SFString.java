/*
 * $RCSfile: SFString.java,v $
 *
 *      @(#)SFString.java 1.10 98/11/05 20:40:40
 *
...
public class SFString extends vrml.Field {
    ...
    public synchronized Object clone() {
        return new SFString(
                (org.jdesktop.j3d.loaders.vrml97.impl.SFString) impl.clone());
    }
    ...
    public SFString(String string) {
        super(null);
        impl = new org.jdesktop.j3d.loaders.vrml97.impl.SFString(string);
        implField = impl;
    }
