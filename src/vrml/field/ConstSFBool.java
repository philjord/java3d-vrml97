/*
 * $RCSfile: ConstSFBool.java,v $
 *
 *      @(#)ConstSFBool.java 1.8 98/11/05 20:40:24
 *
...
public class ConstSFBool extends vrml.ConstField {
     ...
     */
    public Object clone() {
        return new ConstSFBool((org.jdesktop.j3d.loaders.vrml97.impl.ConstSFBool) impl.clone());
    }
