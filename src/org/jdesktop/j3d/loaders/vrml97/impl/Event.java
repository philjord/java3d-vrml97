 ...
 *
 *      @(#)Event.java 1.8 98/11/05 20:34:26
 *
...
public class Event implements Cloneable {
    ...
    public Event(String name, double time, ConstField value) {
        ...
        this.value = value;// if it is a ConstField,
        // the data is a clone of
        // the Nodes real Field,
        // so it is ok to just
     ...
     */
    public Object clone() {
        Object myClone = new Event(name, timeStamp, value);
        return myClone;
    }
