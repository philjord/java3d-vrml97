 ...
 *
 *      @(#)ConstSFBool.java 1.10 98/11/05 20:34:15
 *
...
public class ConstSFBool extends ConstField {
     ...
     *Constructor for the ConstSFBool object
     *
     *@param  bool Description of the Parameter
     */
    ...
    public boolean getValue() {
        return ((SFBool) ownerField).getValue();
    }
    ...
    public synchronized Object clone() {
        return new ConstSFBool((SFBool) ownerField);
    }
