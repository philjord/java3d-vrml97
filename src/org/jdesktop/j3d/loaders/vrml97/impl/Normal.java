/*
 * $RCSfile: Normal.java,v $
 *
 *      @(#)Normal.java 1.20 99/02/11 18:03:43
 *
...
public class Normal extends Node implements Reusable {
     ...
     *
     *@param  loader Description of the Parameter
     *@param  normals Description of the Parameter
     */
    ...
    public void notifyMethod(String eventInName, double time) {
        if (eventInName.equals("vector")) {
            owner.notifyMethod("normal", time);
        }
        if (eventInName.equals("route_vector")) {
            owner.notifyMethod("route_normal", time);
        }
    }

    /**
     *  Gets the type attribute of the Normal object
     *
     ...
     */
    public Object clone() {
        return new Normal(loader, (MFVec3f) vector.clone());
    }

    /**  Description of the Method */
    void initFields() {
        vector.init(this, FieldSpec, Field.EXPOSED_FIELD, "vector");
    }
