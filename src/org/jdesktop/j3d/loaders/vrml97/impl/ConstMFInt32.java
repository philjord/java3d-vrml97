 ...
 *
 *      @(#)ConstMFInt32.java 1.10 98/11/05 20:34:11
 *
...
public class ConstMFInt32 extends ConstMField {
    ...
    public void getValue(int[] values) {
        ((MFInt32) ownerField).getValue(values);
    }
    ...
    public int get1Value(int index) {
        return ((MFInt32) ownerField).get1Value(index);
    }
     ...
     */
    public Object clone() {
        return new ConstMFInt32((MFInt32) ownerField);
    }
