/*
 * $RCSfile: SFTime.java,v $
 *
 *      @(#)SFTime.java 1.10 98/11/05 20:40:41
 *
...
public class SFTime extends vrml.Field {
    ...
    public synchronized Object clone() {
        return new SFTime(
                (org.jdesktop.j3d.loaders.vrml97.impl.SFTime) impl.clone());
    }
    ...
    public SFTime(double time) {
        super(null);
        impl = new org.jdesktop.j3d.loaders.vrml97.impl.SFTime(time);
        implField = impl;
    }
     ...
     *
     *@param  time The new value value
     */
