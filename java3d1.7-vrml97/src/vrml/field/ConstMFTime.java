/*
 * $RCSfile: ConstMFTime.java,v $
 *
 *      @(#)ConstMFTime.java 1.8 98/11/05 20:40:22
 *
...
public class ConstMFTime extends vrml.ConstMField {
     ...
     */
    public Object clone() {
        return new ConstMFTime((org.jdesktop.j3d.loaders.vrml97.impl.ConstMFTime) impl.clone());
    }
}
