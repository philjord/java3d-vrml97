 ...
 *
 *      @(#)ConstSFRotation.java 1.13 98/11/05 20:34:18
 *
...
public class ConstSFRotation extends ConstField {
    ...
    public void getValue(float[] axisAngle) {
        ((SFRotation) ownerField).getValue(axisAngle);
    }
    ...
    public float[] getValue() {
        return ((SFRotation) ownerField).getValue();
    }
     ...
     */
    public Object clone() {
        return new ConstSFRotation((SFRotation) ownerField);
    }
