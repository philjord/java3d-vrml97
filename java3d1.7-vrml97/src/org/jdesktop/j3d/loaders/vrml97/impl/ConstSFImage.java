/*
 * $RCSfile: ConstSFImage.java,v $
 *
 *      @(#)ConstSFImage.java 1.11 98/11/05 20:34:16
 *
...
public class ConstSFImage extends ConstField {
     ...
     */
    public int getWidth() {
        return ((SFImage) ownerField).getWidth();
    }
    ...
    public int getHeight() {
        return ((SFImage) ownerField).getHeight();
    }
    ...
    public int getComponents() {
        return ((SFImage) ownerField).getComponents();
    }
    ...
    public void getPixels(byte[] pixels) {
        ((SFImage) ownerField).getPixels(pixels);
    }
    ...
    public synchronized Object clone() {
        return new ConstSFImage((SFImage) ownerField);
    }
