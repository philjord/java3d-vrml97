/*
 * $RCSfile: NumFormat.java,v $
 *
 *      @(#)NumFormat.java 1.4 98/11/05 20:34:49
 *
...
public class NumFormat {
    ...
    /**Constructor for the NumFormat object */
    public NumFormat() {
     ...
     *@param  numDigits Description of the Parameter
     *@return  Description of the Return Value
     */
    String format(double number, int numDigits) {
        if (digits != numDigits) {
            instance.setMaximumFractionDigits(numDigits);
            digits = numDigits;
        }
