 ...
 *
 *      @(#)ConstMFVec2f.java 1.10 98/11/05 20:34:13
 *
...
public class ConstMFVec2f extends ConstMField {
    ...
    public void getValue(float[][] values) {
        ((MFVec2f) ownerField).getValue(values);
    }
    ...
    public void get1Value(int index, float[] values) {
        ((MFVec2f) ownerField).get1Value(index, values);
    }
    ...
    public void get1Value(int index, SFVec2f vec) {
        ((MFVec2f) ownerField).get1Value(index, vec);
    }
    ...
    public synchronized Object clone() {
        return new ConstMFVec2f((MFVec2f) ownerField);
    }
