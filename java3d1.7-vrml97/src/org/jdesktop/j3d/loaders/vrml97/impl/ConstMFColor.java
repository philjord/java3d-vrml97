 ...
 *
 *      @(#)ConstMFColor.java 1.11 98/11/05 20:34:09
 *
...
public class ConstMFColor extends ConstMField {
    ...
    public void getValue(float[][] values) {
        ((MFColor) ownerField).getValue(values);
    }
    ...
    public void get1Value(int index, float[] values) {
        ((MFColor) ownerField).get1Value(index, values);
    }
    ...
    public void get1Value(int index, SFColor vec) {
        ((MFColor) ownerField).get1Value(index, vec);
    }
     ...
     */
    public Object clone() {
        return new ConstMFColor((MFColor) ownerField);
    }
