 ...
 *
 *      @(#)ConstMFTime.java 1.11 98/11/05 20:34:13
 *
...
public class ConstMFTime extends ConstMField {
    ...
    public void getValue(double[] values) {
        ((MFTime) ownerField).getValue(values);
    }
    ...
    public double get1Value(int index) {
        return ((MFTime) ownerField).get1Value(index);
    }
     ...
     */
    public Object clone() {
        return new ConstMFTime((MFTime) ownerField);
    }
