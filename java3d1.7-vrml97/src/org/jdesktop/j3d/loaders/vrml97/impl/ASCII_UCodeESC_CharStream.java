...
public final class ASCII_UCodeESC_CharStream
{
  ...
  public final char readChar() throws IOException
  {
    ...
    if (++this.bufpos == this.available)
      AdjustBuffSize();
    char c;
    if ((this.buffer[this.bufpos] = c = (char)(0xFF & ReadByte())) == '\\')
    {
      UpdateLineColumn(c);
      ...
      try
      {
        while ((c = (char)(0xFF & ReadByte())) == 'u')
          this.column += 1;
        char tmp329_328 = (char)(hexval(c) << 12 | hexval((char)(0xFF & ReadByte())) << 8 | hexval((char)(0xFF & ReadByte())) << 4 | hexval((char)(0xFF & ReadByte()))); c = tmp329_328; this.buffer[this.bufpos] = tmp329_328;
 ...
 * Qualified Name:     org.jdesktop.j3d.loaders.vrml97.impl.ASCII_UCodeESC_CharStream
